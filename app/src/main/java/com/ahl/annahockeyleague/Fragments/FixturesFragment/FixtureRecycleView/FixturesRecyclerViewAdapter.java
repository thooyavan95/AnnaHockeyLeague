package com.ahl.annahockeyleague.Fragments.FixturesFragment.FixtureRecycleView;
...
public class FixturesRecyclerViewAdapter extends RecyclerView.Adapter<FixturesViewHolder> {

    private ArrayList<Fixtures> fixturesList;
    private static final String TAG = FixturesRecyclerViewAdapter.class.getSimpleName();

    public FixturesRecyclerViewAdapter(ArrayList<Fixtures> fixturesList) {
    ...
    public void onBindViewHolder(@NonNull FixturesViewHolder holder, int position) {
        ...
        Log.d(TAG, "on bind view holder");
            ((TextView) holder.itemView.findViewById(R.id.next_match_fixture_colon)).setText(":");
